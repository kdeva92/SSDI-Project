...
void loadSignupPage(Presenter present) throws IOException{
	...
	VBox signUpBox = (VBox) FXMLLoader.load(Login.class.getResource("/org/ChatApplication/ui/service/stylesheets/SignUpWindow.fxml"));
	...
	signUpBtn.setOnAction(new EventHandler<ActionEvent>() {
		...
		public void handle(ActionEvent event) {
			...
			System.out.println(user.getNinerId()+" "+user.getFirstName()+" "+user.getLastName()+" "+user.getEmail()+" "+user.getPassword());
		}
	});
